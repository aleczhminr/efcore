        ...
        private sealed class ShaperProcessingExpressionVisitor : ExpressionVisitor
        {
                ...
                where TIncludingEntity : TEntity
            {
                if (entity is TIncludingEntity includingEntity)
                {
                    ...
                    {
                        NavigationBaseExtensions.SetIsLoadedWhenNoTracking(navigation, includingEntity);
                        if (relatedEntity != null)
                        {
                            ...
                            if (inverseNavigation != null
                                && !inverseNavigation.IsCollection)
                            {
                                NavigationBaseExtensions.SetIsLoadedWhenNoTracking(inverseNavigation, relatedEntity);
                            }
                        }
                    }
                }
                ...
                where TNavigationEntity : TParent
            {
                ...
                if (entity is TNavigationEntity)
                {
                    ...
                    {
                        NavigationBaseExtensions.SetIsLoadedWhenNoTracking(navigation, entity);
                    }
